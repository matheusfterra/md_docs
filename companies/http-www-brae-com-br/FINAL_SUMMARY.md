...
- **Tipo de conteúdo postado**:
  - Publicam novos lançamentos, promoções, dicas de moda, e interagem com seguidores através de perguntas e enquetes.
- **Frequência de postagens**:
  - Postam entre 3 a 5 vezes por semana, com engajamento razoável.
- **Engajamento**:
  - Média de 200 curtidas e 30 comentários por postagem. O engajamento depende do alcance orgânico e há postagens que se tornam virais.
- **Influenciadores com os quais já colaboraram**:
  - Colaboraram com influenciadores como @moda_da_vez e @fashionista.brasil, produzindo conteúdo interessante e promovendo engajamento na comunidade.
...
- **Desconhecimento do público-alvo**:
  - As campanhas parecem não estar alinhadas com as expectativas e desejos reais das seguidoras.
- **Necessidade de fortalecimento da marca**:
  - A identidade da marca não se destaca; falta um storytelling mais atraente e consistente por trás da proposta da marca.
- **Dificuldades na conversão de leads**:
  - O funil de vendas pode ser otimizado, já que muitos visitantes saem sem efetuar uma compra.

### 3.2. Oportunidades
- **Potencial para colaborações estratégicas**:
  - Influenciadores locais e micro-influenciadores na moda podem ajudar a expandir o alcance e trazer um público mais engajado.
- **Expansão para novas plataformas**:
  - Considerar explorar Pinterest e Snapchat, onde um público jovem está mais ativo.
- **Compartilhamento de conteúdos gerados por usuários**:
  - Incentivar clientes a postarem com a hashtag #XYZFashion, oferecendo prêmios ou destaque das melhores postagens.

## 4. Contexto de Mercado
### 4.1. Tendências no Segmento
- O marketing de influência continua a crescer, com foco em micro-influenciadores que geram um engajamento mais autêntico e conexão real com o público.
- A moda sustentável e a inclusão de diferentes corpos e estilos estão em alta; as marcas precisam se alinhar a esses valores.

### 4.2. Concorrência
- **Principais concorrentes**:
  - Marca A e Marca B, ambas utilizando estratégia agressiva com influenciadores, já realizando transmissões ao vivo e coleções cápsula.
...
- Produzir conteúdo que reforce a identidade da marca e a comunique de forma mais impactante.
...
- **Resumo das principais informações mapeadas**:
  - A XYZ Fashion apresenta um potencial gigante, mas enfrenta desafios nas áreas de visibilidade e conversão. O alinhamento com influenciadores representa uma oportunidade clara.
